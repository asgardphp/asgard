...
class ViewTest extends \PHPUnit_Framework_TestCase {
	public function testView() {
		...
		$this->assertEquals('<h1>hello!</h1>', View::renderFile(__DIR__.'/Fixtures/template.php', ['test' => 'hello!']));
	}

	public function testViewable() {
		$this->assertEquals('<h1>hello world!</h1>', Viewable::fragment('Asgard\Hook\Tests\_Viewable', 'test'));
	}
}
